...
public abstract class HoldConfirmButton extends ClassicButton {
    ...
    public void playDownSound(SoundManager soundManager) {
        // Hold feedback uses SPELL_FILL and SPELL_LEARN instead of the regular UI click.
    }
    ...
    protected AnimationCompat.TextEffect getTitleEffect() {
        ...
        return AnimationCompat.TextEffect.shake(0.4f + holdProgress * 0.8f,
                1.0f + holdProgress * 2.0f);
    }
