...
public final class Configuration {
    ...
    public static ModConfigSpec.EnumValue<LearnType> SCHOOLS_PRICE_TYPE;
    public static ModConfigSpec.IntValue XP_BASE_COST;
    public static ModConfigSpec.DoubleValue PRICE_XP_MULTIPLIER;
    public static ModConfigSpec.DoubleValue XP_COST_GROWTH;
    public static ModConfigSpec.IntValue XP_MINIMUM_LEVEL;
    public static ModConfigSpec.BooleanValue XP_ALLOW_BULK_LEARNING;
    public static ModConfigSpec.BooleanValue XP_RESPECT_MAX_SCHOOLS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SCHOOL_XP_COSTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> UNIQUE_SPELL_INFO;
